...
const LINE_STOP_STATIONS: Record<string, Record<string, string[]>> = {
  TC: { // 土浦線
    '普通': [], // 空配列なら全駅停車扱い
    '各停': [],
    '区間快速': ['松戸', '新松戸', '柏', '守谷', '荒川沖', '土浦', '高浜', '茨城空港', '大洗', '那珂湊', '平磯', 'ひたちなか海浜公園', '大甕（おおみか）', '多賀', '日立'],
    '快速': ['松戸', '柏', '守谷', '谷井田', '森の里', '土浦', '茨城空港', '大洗', '那珂湊', '平磯', 'ひたちなか海浜公園', '大甕（おおみか）', '多賀', '日立'],
    '特別快速': ['松戸', '柏', '守谷', '土浦', '茨城空港', 'ひたちなか海浜公園', '大甕（おおみか）', '日立'],
    '通勤特快': ['松戸', '柏', '守谷', '土浦', 'ひたちなか海浜公園', '日立'],
    '特急めぐり': ['松戸', '柏', '守谷', '土浦', '茨城空港', 'ひたちなか海浜公園', '大甕（おおみか）', '日立'],
  },
  Y: { // 神埼線
    '各停': [], // 空配列なら全駅停車扱い
    '普通': [],
...
const generateDeterministicDeparture = (
  ...
  if (chosenLine.key === 'TC') {
    if (platform === 1) {
      rawDestinations = ['守谷', '土浦', '茨城空港', '大洗', 'ひたちなか海浜公園', '大甕（おおみか）', '日立'];
    } else {
